/**
 * 浮动工具栏内置动作（解释这段/生成白话/图解/提问）
 * 与自定义动作统一在「浮动工具栏」配置里管理，编辑表单也完全一致（名称/说明/模板）。
 * 提问为内置提示词，选区即触发，无需用户输入问题。
 * 执行差异：模板保持系统默认时走结构化锚定链路（解读锚定原文、术语白话附着文档、图解锚定选区、提问回答锚定原文并附候选词条）；
...
const BUILTIN_TOOLBAR_ACTION_DEFS = Object.freeze([
  ...
  },
  {
    id: 'ask',
    name: '提问',
    description: '内置提问：这段说的是什么概念、有什么作用；回答锚定原文，适合入库的概念会给出候选词条',
    promptTemplate: '请针对以下选中内容回答：这段说的是什么核心概念或机制？它是什么、有什么作用，最容易困惑的地方在哪里？\n\n选中内容：\n{{selection}}',
  },
]);
