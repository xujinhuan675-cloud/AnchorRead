...
- Use elbowed right-angle waypoints for cross-lane routes and curved waypoints for fan-out. Encode them in \`points\` (relative to the connector's \`x/y\`) and set \`elbowed: true\`; the binding resolver must retain intermediate points.
