...
export function getConfig() {
  ...
  return {
    ...
    userContext: typeof activeConfig.userContext === 'string' ? activeConfig.userContext : '',
    promptPresets: Array.isArray(activeConfig.promptPresets) ? activeConfig.promptPresets : [],
  };
}
