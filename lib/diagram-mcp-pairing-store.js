...
export class InMemoryDiagramMcpPairingStore {
  ...
  // OAuth authorization codes are approved by the already-paired browser.
  // They do not have the browser's management secret, so this method only
  // accepts a workspace that was registered by that browser first.
