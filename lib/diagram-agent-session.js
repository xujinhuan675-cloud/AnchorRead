...
// Renew well before the lease expires so a long-poll request can safely span
// several lease intervals without losing ownership between claim and resolve.
export const DIAGRAM_AGENT_LEASE_HEARTBEAT_MS = Math.max(1_000, Math.floor(DIAGRAM_AGENT_LEASE_MS / 2));
