import { buildDocumentPath } from './workspace-routes.js';
import { getDocumentRouteId } from './document-route-id.js';
...
export function buildDocumentReaderHref(document) {
  return buildDocumentPath(getDocumentRouteId(document));
}
